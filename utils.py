...
def fetch_numeric_id(accession, email="your_email@example.com", tool="FetchOmics",

                     api_key=None, max_retries=10, delay=5):

    """

    If api_key is not None, it will be added to the E-utilities request.
